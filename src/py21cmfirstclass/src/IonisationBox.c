                                ...
                                for (z = 0; z < user_params->HII_DIM; z++)
                                {
                                    ...
                                    else
                                    {
                                        if (user_params->USE_RELATIVE_VELOCITIES)
                                        {
                                            ...
                                            {
                                                curr_vcb = ((1. - pow(10., -cosmo_params->f_chi)) * (ini_boxes->lowres_vcb[HII_R_INDEX(x, y, z)]) + pow(10., -cosmo_params->f_chi) * (spin_temp->V_chi_b_box[HII_R_INDEX(x, y, z)]) * (1. + global_params.Z_REC) / (1. + redshift));
                                            }
                                            else
                                            {
