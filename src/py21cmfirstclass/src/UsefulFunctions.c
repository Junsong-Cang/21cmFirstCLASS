...
double Collisional_Ionization_Rate(double T)
{
    /*
    Collisional ionization rate following Scholz91, APJ
    */
    double LgT_ax[36] = {3.284, 3.320, 3.411, 3.565, 3.802, 4.034, 4.258, 4.448, 4.586, 4.706, 4.836, 4.982, 5.128, 5.255, 5.404, 5.539, 5.659, 5.771, 5.875, 6.023, 6.104, 6.169, 6.237, 6.357, 6.466, 6.565, 6.693, 6.792, 6.935, 7.021, 7.154, 7.362, 7.547, 7.677, 7.799, 8.013};
    double Gamma_ax[36] = {1.668, 1.779, 2.038, 2.668, 3.743, 5.337, 7.116, 9.154, 10.896, 12.674, 14.602, 17.159, 19.716, 22.236, 24.941, 27.276, 29.018, 30.389, 31.390, 31.797, 31.872, 31.834, 31.464, 30.574, 29.648, 28.462, 26.572, 25.201, 23.014, 21.791, 19.642, 16.751, 14.342, 12.712, 11.340, 9.376};
    double LgT, r;
    LgT = log10(T);
    if (LgT < LgT_ax[0]) || (LgT > LgT_ax[35])
    {
        r = -1.0;
    }
    else
    {
        r = Interp_1D(x, LgT_ax, Gamma_ax, 36, 0, 0, 0);
    }
    return r;
}
