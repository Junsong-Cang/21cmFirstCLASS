...
double dicke(double z)
{
    ...
    {
        // Added checks that z must be higher than the interpolation range (LOG_Z_ARR) otherwise growth factor can be NaN, should be ok because at such low z both cases are the same
