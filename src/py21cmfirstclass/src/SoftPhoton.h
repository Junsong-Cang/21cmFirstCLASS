...
double Compute_dTffdz(double *zax, double *dTdz, double *Hax, double *xe_ax, double *Tkax, double *SFRD_II_ax, double *SFRD_III_ax, double fR_II, double fR_III, double aR_II, double aR_III, double OmBh2, double YHe, int nz)
{
	/*
	...
	*/
	...
	double z, xe, Tk, dz, dtff, xi, Tcmb, SFRD_II, SFRD_III, exp_dtff_inv, H, dninj_dtff, S_inj;
	int xid, zid;
	FILE *OutputFile;
