...
// *M_uv_z_MINI, *M_h_z_MINI; // JSC: Mac installation error
...
double TF_CLASS(double k, int flag_int, int flag_dv)
{
    ...
    if (log10_k > log10_kclass[CLASS_LENGTH - 1])
    { // k>kmax
...
double sigma_z0(double M, double z)
{ // JordanFlitter: added redshift argument
 ...
 */
double dNdM_st(double growthf, double M, double z)
{ // JordanFlitter: added redshift argument
 ...
 */
double dNdM_WatsonFOF(double growthf, double M, double z)
{ // JordanFlitter: added redshift argument
 ...
 */
double dNdM(double growthf, double M, double z)
{ // JordanFlitter: added redshift argument
...
double FgtrM_Watson(double growthf, double M, double z)
{ // JordanFlitter: added redshift argument
    double result, error, lower_limit, upper_limit;
    gsl_function F;
    double rel_tol = 0.001; //<- relative tolerance
    ...
    struct parameters_gsl_FgtrM_int_ parameters_gsl_FgtrM = {
        // JordanFlitter: added that line to pass redshift argument
        .z_obs = z,
        .gf_obs = growthf,
    };
...
float dNdM_conditional(float growthf, float M1, float M2, float delta1, float delta2, float sigma2, float z)
{ // JordanFlitter: added redshift argument
...
double Nion_ConditionalM_MINI(double growthf, double M1, double M2, double sigma2, double delta1, double delta2, double MassTurnover, double MassTurnover_upper, double Alpha_star, double Alpha_esc, double Fstar10, double Fesc10, double Mlim_Fstar, double Mlim_Fesc, bool FAST_FCOLL_TABLES, double z)
{ // JordanFlitter: added redshift argument
...
double Nion_ConditionalM(double growthf, double M1, double M2, double sigma2, double delta1, double delta2, double MassTurnover, double Alpha_star, double Alpha_esc, double Fstar10, double Fesc10, double Mlim_Fstar, double Mlim_Fesc, bool FAST_FCOLL_TABLES, double z)
{ // JordanFlitter: added redshift argument
...
float GaussLegendreQuad_Nion_MINI(int Type, int n, float growthf, float M2, float sigma2, float delta1, float delta2, float MassTurnover, float MassTurnover_upper, float Alpha_star, float Alpha_esc, float Fstar7_MINI, float Fesc7_MINI, float Mlim_Fstar_MINI, float Mlim_Fesc_MINI, bool FAST_FCOLL_TABLES, float z)
{ // JordanFlitter: added redshift argument
...
float GaussLegendreQuad_Nion(int Type, int n, float growthf, float M2, float sigma2, float delta1, float delta2, float MassTurnover, float Alpha_star, float Alpha_esc, float Fstar10, float Fesc10, float Mlim_Fstar, float Mlim_Fesc, bool FAST_FCOLL_TABLES, float z)
{ // JordanFlitter: added redshift argument
